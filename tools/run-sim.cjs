...
const N=20000;
const BL=["작은","큰","보스"];
const STRAT_KO={balance:"밸런스 빌드",flush:"플러시 빌드",black:"흑심(검정/2색) 빌드",jokbo:"족보(중개상+쌍둥이) 빌드",compact:"압축(정련가+잔챙이) 빌드",spatial:"위치-맥락(다리+계단+주춧돌) 빌드"};
for(const strat of ["balance","flush","black","jokbo","compact","spatial"]){
