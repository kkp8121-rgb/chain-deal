...
> **📍 중장기 로드맵(웹리서치 2026-06-25) = HANDOVER §7 🧭.** NEAR(모바일 베이스라인·세로레이아웃·공유결과) → MID(난이도 사다리·위치맥락 부적·부적 20~25종, ⚠️보스 추가 금지) → LONG(시작덱 변형·Steam 포트). 수익화 보류.
